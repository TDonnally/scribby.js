...
import { LLMSummaryController } from "./LLMSummaryController.js";
...
export class Toolbar {
    ...
    LLMOutput: LLMSummaryController;
    ...
    constructor(
        ...
        this.tabAudioText = new SpeechToText(scribby,
            ...
            `, Input.speaker);
        this.LLMOutput = new LLMSummaryController(scribby,
            `
